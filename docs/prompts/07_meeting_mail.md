...
**메일 제목:** [더 어반 십] 회의 후속 조치: 제안 가격 및 서비스 아이디어 조율 결과 안내

**수신:** 박서준 마케팅팀장님, 최지혜 브랜드 매니저님

안녕하십니까. 유어미디어 **사용자님 (요청자 본인)**입니다.

지난 10월 23일, ‘스파클링 아이스티’ 론칭 캠페인 킥오프 미팅에 귀한 시간을 내어주시고 제품의 핵심 가치를 공유해 주신 점에 깊이 감사드립니다.

저희는 오늘 논의된 내용을 바탕으로 타겟 이미지를 명확히 하고, 총 예산 2억 원 내에서 최고의 효율을 낼 수 있도록 세부 전략을 확정했습니다. 주요 내용을 아래와 같이 정리하여 안내해 드립니다.

---

### **a. 회의 핵심 요약 및 주요 논의 주제**

이번 회의는 '프리미엄 블렌딩 티'의 깊은 풍미를 바탕으로, '지친 일상 속, 나를 위한 **세련된 휴식**'이라는 핵심 키워드를 **프로페셔널하고 감각적인 30대 커리어 우먼** 타겟에게 전달하는 데 집중되었습니다.

크리에이티브 콘셉트는 **"Urban Oasis (도심 속 오아시스)"**로 확정되었으며, 2040 직장인 선호도가 높은 미디어에 집중하는 전략으로 **수도권 내 인지도 30% 상승**을 KPI로 설정했습니다.

### **b. 최종 가격 조율 결과 (총 예산 2억 원 기준)**

클라이언트께서 제시하신 총 예산 2억 원을 기준으로, 제작비와 매체 집행비를 아래와 같이 확정하여 진행하는 것을 목표로 합니다.

| 구분 | 조정된 서비스 범위 및 조건 | 확정 금액 (VAT 별도) |
|:-----|:-------------------------------------------|:-------------------|
| **1. 광고 콘텐츠 제작 및 컨설팅** | **TV CF 영상 제작 (Standard Package)**: 30초 영상 1편 제작 (당사 Standard 범위 3,000만 원 ~ 8,000만 원). 기획, 2~3일 촬영, 전문 편집 및 색 보정, 3D 그래픽 일부 포함. (라디오 광고 및 인쇄 광고 디자인, KPI 측정 포함) | **5,000만 원** |
| **2. 광고 매체 집행 (Media Buy)** | 2040 직장인 타겟 집중형 매체 믹스 집행. (TV, 라디오, 인쇄 매체 집행 비용). | **1억 5,000만 원** |
| **총계** | | **2억 원** |

* *특이사항: 5,000만 원의 제작비에는 TV CF 제작비 외에도 라디오 광고 제작 (음성형 50만 원 ~ 150만 원) 및 인쇄 매체 디자인 비용 (단순 시안 50만 원 ~ 150만 원), KPI 측정을 포함한 프로젝트 기반 컨설팅 비용이 모두 통합되어 최적화된 가격으로 반영됩니다.*

### **c. 아이디어/서비스 범위 확정**

회의에서 합의된 내용을 바탕으로 캠페인 진행 범위를 다음과 같이 확정합니다.

1.  **크리에이티브 콘셉트**: **"Urban Oasis"**를 최종 콘셉트로 확정합니다. 삭막한 도시와 대비되는 청량한 제품 이미지 및 제품을 마시는 순간 고요해지는 **반전 연출**을 핵심으로 제작을 진행합니다.

2.  **미디어 믹스**: 2040 직장인 선호도가 높은 매체 중심으로 집행합니다. **TV (tvN, JTBC 프라임 타임), 라디오 (출퇴근 시간대 SBS 파워FM, MBC FM4U), 인쇄 (경제지, 라이프스타일 매거진)**에 집중합니다.

3.  **KPI 측정**: 캠페인 목표인 **수도권 내 인지도 30% 상승** 달성을 위해 캠페인 시작 전과 종료 후, 전문 리서치 기관을 통해 인지도 조사를 2회 실시하여 객관적인 데이터 변화를 측정할 것입니다.

### **d. 다음 단계 (고객에게 기대하는 구체적인 후속 조치 요청)**

회의에서 결정된 행동 계획에 따라, 다음 주 초까지 구체적인 실행 계획을 담은 공식 제안서를 전달할 예정입니다.

1.  **공식 제안서 발송**: 오늘 논의된 내용을 모두 반영한 **구체적 매체 스케줄, 예산안, 제작 타임라인**을 포함한 공식 제안서를 **2025년 10월 28일 (화)**까지 발송하겠습니다.

2.  **내부 검토 및 피드백**: 제안서 수신 후, 내부적으로 내용을 검토하시고 신속한 피드백을 부탁드립니다.

궁금한 점이나 추가적으로 논의가 필요한 부분이 있다면 언제든지 편하게 연락 주십시오. 저희 유어미디어는 '스파클링 아이스티'의 성공적인 론칭을 위해 최선을 다하겠습니다.
